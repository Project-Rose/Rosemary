...
class Miscellaneous(commands.Cog):
    ...
    async def mii(
        ...
        try:
            ...
            # we decode and store the mii data in a bytesio object
            ...
            mii_json['data'] = base64.b64encode(mii_data.getvalue())
            ...
            embed.add_field(name="Mii data (base64)", value=str(mii_json["data"],encoding="utf-8"), inline=False)
